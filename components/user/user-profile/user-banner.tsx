...
export default function Banner() {
  return (
    <div className="container grid grid-cols-12 mx-auto">
      <div className="card rounded-b-none col-start-4 col-span-6 bg-rose-400 z-10">
        <div className="flex justify-end">
          <Button link="/register" className="rounded-xl bg-zinc-800 p-2">
            <h3 className="text-xs">Edit Profile</h3>
          </Button>
